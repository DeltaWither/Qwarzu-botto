...
export default function Home() {
    return (
        <div className="container">
          ...
          <p>Right now I don't think a single soul has looked at this outside of Qwarzu Outposto, but if you
            are, then basically the point of this bot is better custom commands. The bot is completely open
            source, so anyone can just copy it, host it for their Discord server, and edit or create any command
            with the full power of Javascript.</p>
          ...
          <p>Commands are one time executions. You just type "?commandname" in chat and something happens.
            Listeners get executed on certain events defined by Discord, like a message being sent, a role being
            created... Schedules execute on certain times, however many times you want.</p>

          <p>Another feature of Qwarzu Botto is member groups, which is this bot's way to handle permissions to
            execute certain commands. Member groups check whether a member passes certain checks, like having
          ...
          <p>Whether you faint on the sight of a line of code or you are a 60 year old Linux kernel hacker with
            ...
            features on a basic level and how to handle them without any coding. Then I'll explain how to create
            your own commmands, listeners, schedules, groups and such, and in the end I'll explain the entire
