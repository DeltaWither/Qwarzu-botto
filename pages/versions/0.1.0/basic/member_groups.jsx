export default function MemberGroups() {
    return (
        <div className="container">
          ...
          <p>Member groups are similar to Discord roles, but more powerful. While a Discord role is essentially a
            list of individual members, membership of a member role can depend on individual users, roles the
            user has, permissions, and potentially any arbitrary rule if you can code, such as their name being
            a specific way or having been in the server for a certain amount of time.</p>
          ...
          <p>The point of groups right now is just to allow clean permission checks for commands. A command's
            execute group is a member group which in this case represents the set of people who can execute it.
